...
export async function api(path, opts={}){
  ...
  const resp = await fetch(path, { method:opts.method||'GET', credentials:'include', headers, body: opts.body && typeof opts.body==='object' ? JSON.stringify(opts.body) : opts.body });
